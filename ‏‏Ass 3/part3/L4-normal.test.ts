...
import { parseL4, makePrimOp } from '../part3/L4-ast';
import { listPrim } from "../part3/evalPrimitive";
import { evalNormalParse, evalNormalProgram } from '../part3/L4-normal';
import { isClosure, Value } from '../part3/L4-value';
...
//     });
    ...
    it('ourSpecialTest3', () => {
        ...
        (g (loop 0) 7))`), evalNormalProgram)).to.deep.equal(makeOk(7));
    });
});
